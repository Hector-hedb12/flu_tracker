"""
Base settings for Flu Tracker project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (flu_tracker/config/settings/base.py - 3 = flu_tracker/)
APPS_DIR = ROOT_DIR.path('flu_tracker')
...
LOCAL_APPS = [
    'flu_tracker.classifiers.apps.ClassifiersConfig',
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'flu_tracker.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///flu_tracker'),
}
...
ACCOUNT_ADAPTER = 'flu_tracker.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'flu_tracker.users.adapters.SocialAccountAdapter'
...
TWITTER_QUERIES = ['flu -rt -http', 'sick -rt -http', 'cough -rt -http']
